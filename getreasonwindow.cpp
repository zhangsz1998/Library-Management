...
GetReasonWindow::GetReasonWindow(QWidget *parent) : QDialog(parent)
{
    ...
    closeBtn->setGeometry(this->width()-30*dpi,0*dpi,30*dpi,30*dpi);
    ...
    reason1->setStyleSheet({"background-color:#ffffff"});
    ...
    reason2->setStyleSheet({"background-color:#ffffff"});
    ...
    reason3->setStyleSheet({"background-color:#ffffff"});
    ...
    reason4->setStyleSheet({"background-color:#ffffff"});
    ...
    reason5->setStyleSheet({"background-color:#ffffff"});
    ...
    reason6->setStyleSheet({"background-color:#ffffff"});
    ...
    reason7->setStyleSheet({"background-color:#ffffff"});
    ...
    reason8->setStyleSheet({"background-color:#ffffff"});
    ...
    reason9->setStyleSheet({"background-color:#ffffff"});
